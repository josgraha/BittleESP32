...
template <typename T>
void transform(T *target, byte angleDataRatio = 1, float speedRatio = 1, byte offset = 0)
{
  //  PTL("transform");
...
#define WEIGHT 2
template <typename T>
void transformCubic(T *target, byte angleDataRatio = 1, float speedRatio = 2, byte offset = 0)
{
  {
